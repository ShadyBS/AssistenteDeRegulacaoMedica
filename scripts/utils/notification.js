  ...
  async notifySecurityAlert(severity, issue, details) {
    ...
    const message = {
      ...
      fields: [
        ...
        { name: 'Action Required', value: 'Review security report and address immediately', inline: false },
        { name: 'Timestamp', value: new Date().toISOString(), inline: false }
      ],
    ...
    const discordPayload = {
      embeds: [{
        ...
        footer: {
          ...
          icon_url: 'https://raw.githubusercontent.com/ShadyBS/AssistenteDeRegulacaoMedica/main/icons/icon48.png'
        },
  ...
  async sendSlackNotification(message) {
    ...
    const slackPayload = {
      ...
      attachments: [{
        ...
        footer_icon: 'https://raw.githubusercontent.com/ShadyBS/AssistenteDeRegulacaoMedica/main/icons/icon16.png',
