...
function _init() {
  _init = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* () {
    ...
    try {
      yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .getBaseUrl */ .$_();
    } catch (error) {
    ...
    const [globalSettings, regulationPriorities] = yield Promise.all([loadConfigAndData(), _api_js__WEBPACK_IMPORTED_MODULE_1__/* .fetchRegulationPriorities */ .$4()]);
...
function _handleViewRegulationAttachment() {
  _handleViewRegulationAttachment = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* (button) {
    ...
    try {
      const fileUrl = yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .fetchRegulationAttachmentUrl */ .DM({
        idp,
        ids
      });
      if (fileUrl) {
...
function _handleShowRegulationDetailsModal() {
  _handleShowRegulationDetailsModal = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* (button) {
    ...
    try {
      const data = yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .fetchRegulationDetails */ .hr({
        reguIdp: idp,
        reguIds: ids
      });
...
function _handleShowAppointmentDetailsModal() {
  _handleShowAppointmentDetailsModal = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* (button) {
    ...
    try {
      ...
      let content;
      if (isExam) {
        data = yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .fetchExamAppointmentDetails */ .Pn({
          idp,
          ids
        });
        content = formatExamAppointmentDetailsForModal(data);
      } else {
        data = yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .fetchAppointmentDetails */ .EI({
          idp,
          ids
        });
...
function renderRecentPatients() {
  ...
  const recents = _store_js__WEBPACK_IMPORTED_MODULE_2__/* .store */ .M.getRecentPatients() || [];
...
function renderPatientListItem(patient) {
  ...
  const nome = patient.value || _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getNestedValue */ .LJ(patient, 'entidadeFisica.entidade.entiNome') || 'Nome não informado';
  ...
  const dataNascimento = patient.dataNascimento || _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getNestedValue */ .LJ(patient, 'entidadeFisica.entfDtNasc');
  const cpf = patient.cpf || _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getNestedValue */ .LJ(patient, 'entidadeFisica.entfCPF');
...
const handleSearchInput = _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .debounce */ .sg(/*#__PURE__*/(0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* () {
  const searchTerm = searchInput.value.trim();
  _store_js__WEBPACK_IMPORTED_MODULE_2__/* .store */ .M.clearPatient();
  ...
  _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .toggleLoader */ .i1(true);
  try {
    const patients = yield _api_js__WEBPACK_IMPORTED_MODULE_1__/* .searchPatients */ .bW(searchTerm);
    renderSearchResults(patients);
  } catch {
    _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .showMessage */ .rG('Erro ao buscar pacientes.');
  } finally {
    _utils_js__WEBPACK_IMPORTED_MODULE_3__/* .toggleLoader */ .i1(false);
  }
}), 500);
...
function _handleResultClick() {
  _handleResultClick = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* (event) {
    ...
    if (listItem.classList.contains('recent-patient-item')) {
      const recentPatient = _store_js__WEBPACK_IMPORTED_MODULE_2__/* .store */ .M.getRecentPatients().find(p => {
      ...
      if (recentPatient && recentPatient.ficha) {
        _store_js__WEBPACK_IMPORTED_MODULE_2__/* .store */ .M.setPatient(recentPatient.ficha, recentPatient.cadsus);
        searchInput.value = '';
        searchResultsList.classList.add('hidden');
        recentPatientsList.classList.add('hidden');
        return;
...
function init(config) {
  ...
  _store_js__WEBPACK_IMPORTED_MODULE_2__/* .store */ .M.subscribe(() => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [96,76], () => (__webpack_require__(778)))
