...
/* harmony import */ var _KeepAliveManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./KeepAliveManager.js */ "./KeepAliveManager.js");
...
api.runtime.onMessage.addListener(/*#__PURE__*/function () {
  var _ref = (0,bluebird__WEBPACK_IMPORTED_MODULE_0__.coroutine)(function* (message, sender, sendResponse) {
    if (message.type === 'SAVE_REGULATION_DATA') {
      ...
      try {
        const regulationDetails = yield (0,_api_js__WEBPACK_IMPORTED_MODULE_2__.fetchRegulationDetails)(message.payload);
...
new _KeepAliveManager_js__WEBPACK_IMPORTED_MODULE_3__.KeepAliveManager();
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors","common"], () => (__webpack_require__("./background.js")))
